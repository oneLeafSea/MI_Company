...
- (instancetype)initWithFrame:(CGRect)frame dataSource:(id<AGEmojiKeyboardViewDataSource>)dataSource {
    ...
    // initialize category
        ...
        self.sendButton.backgroundColor = [UIColor colorWithRed:0x66/255.0f green:0x66/255.0f blue:0x66/255.0f alpha:1.0];
        self.sendButton.frame = CGRectMake(CGRectGetWidth([UIScreen mainScreen].bounds) - 60, 180, 50, 30);
