//
//  RTMessagesMediaPlaceholderView.m
//  RTMessages
//
...
@implementation RTMessagesMediaPlaceholderView
...
+ (instancetype)viewWithActivityIndicator
{
    ...
    spinner.color = [lightGrayColor rt_colorByDarkeningColorWithValue:0.4f];
    
    RTMessagesMediaPlaceholderView *view = [[RTMessagesMediaPlaceholderView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 200.0f, 120.0f)
...
{
    UIColor *lightGrayColor = [UIColor rt_messageBubbleLightGrayColor];
    UIImage *paperclip = [[UIImage rt_defaultAccessoryImage] rt_imageMaskedWithColor:[lightGrayColor rt_colorByDarkeningColorWithValue:0.4f]];
