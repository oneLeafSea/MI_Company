...
- (void)setUp
{
    ...
    self.bkgImageView.image = [[UIImage imageNamed:@"multisel_panelbkg"]resizableImageWithCapInsets:UIEdgeInsetsMake(5, 5, 5, 5)];
    ...
    [self.confirmBtn setBackgroundImage:[[UIImage imageNamed:@"multisle_confirm"] resizableImageWithCapInsets:UIEdgeInsetsMake(8, 8, 8, 8)] forState:UIControlStateNormal];
}
