...
- (void)didConfirmWithMultiSelectedPanel:(MultiSelectedPanel*)multiSelectedPanel
{
    [self dismissViewControllerAnimated:YES completion:^{
        if ([self.delegate respondsToSelector:@selector(MultiSelectViewController:didConfirmWithSelectedItems:)]) {
            [self.delegate MultiSelectViewController:self didConfirmWithSelectedItems:self.selectedItems];
        }
    }];
}
