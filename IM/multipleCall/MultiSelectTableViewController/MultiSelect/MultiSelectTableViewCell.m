...
- (void)setSelectState:(MultiSelectTableViewSelectState)selectState
{
    ...
    switch (selectState) {
        case MultiSelectTableViewSelectStateNoSelected:
            self.selectImageView.image = [UIImage imageNamed:@"multisel_notselected"];
            break;
        case MultiSelectTableViewSelectStateSelected:
            self.selectImageView.image = [UIImage imageNamed:@"multisel_bluecell"];
            break;
        case MultiSelectTableViewSelectStateDisabled:
            self.selectImageView.image = [UIImage imageNamed:@"multisel_graycell"];
            break;
        default:
            break;
    }
